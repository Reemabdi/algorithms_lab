...
public static List<Edge> kruskalbefore(int edge ) {
    // TODO Auto-generated method stub
    throw new UnsupportedOperationException("Unimplemented method 'kruskal'");
    kruskalMST(Edges.size(), new ArrayList<> (edge));
long startTime =
System.nanoTime ();
List<Edge> mst =
Kruskal.kruskalbefore(edge);
long endTime =
System.nanoTime(|);
float elapsedTime = (endTime -startTime) /1000;
System.out.printf("Kruskal (Before) - Edges: %d, Time: %.6f seconds|n", Edge.size(),elapsedTime);
}}